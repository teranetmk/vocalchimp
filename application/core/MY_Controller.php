...
class MY_Controller extends CI_Controller {
   ...
   function __construct() {
	   ...
	   if ($this->setting->kyc && !$_SESSION['is_admin'] && !my_kyc_check($_SESSION['user_ids'])) {
		   ...
		   if ($requestURI != 'user/pay_recurring' && $requestURI != 'user/pay_once' && $requestURI != 'user/pay_success' && $requestURI != 'user/pay_cancel' && $requestURI != 'user/pay_now' && $requestURI != 'user/pay_credit_card' && $requestURI != 'user/create_subscription' && $requestURI != 'user/pay_promocode') {
	   ...
	   // get config of tts (table: tts_configuration)
