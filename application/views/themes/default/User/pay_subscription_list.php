...
<div class="container-fluid">
  <div class="row">
    <div class="col-lg-4 text-left">
	  <h1 class="h3 mb-4 text-gray-800"><?=my_caption('menu_sidebar_my_payment_subscription')?>s</h1>
	</div>
  </div>
  <div class="row">
    <div class="col-lg-12">
	  ...
	  <div class="card shadow mb-4">
	    <div class="card-header py-3">
		  <h6 class="m-0 font-weight-bold text-primary"><?=my_caption('menu_sidebar_my_payment_subscription')?>s</h6>
        </div>
        <div class="card-body">
