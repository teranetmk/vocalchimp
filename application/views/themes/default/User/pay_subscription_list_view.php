        ...
        <div class="card-body">
		  <div class="row mb-5">
			...
			<div class="col-lg-6">
			  ...
			  <?php echo my_esc_html($rs_item->item_currency . ' ' . my_proper_price($rs_item->item_price) . ' per ' . $rs_item->recurring_interval_count . ' ' . my_caption('payment_' . 'interval_' . $rs_item->recurring_interval)); ?>
			</div>
		  </div>
