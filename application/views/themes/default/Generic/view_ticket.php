	...
	<div class="col-lg-4">
	  ...
	  <div class="card shadow mb-4">
        ...
        <div class="card-body">
		  <div class="row">
		    <div class="col-lg-12">
			  <a id="Rating3" class="hand-cursor" onclick="actionQuery('<?=my_caption('support_ticket_rating')?>', '<?=my_caption('support_ticket_rating_3')?>, Are you sure?', '<?=base_url('user/ticket_rating_action/' . $rs->ids . '/3/')?>', '')"><span class="dot-green mr-1"></span> <?=my_caption('support_ticket_rating_3')?></a>
			</div>
		    <div class="col-lg-12 mt-3">
			  <a id="Rating2" class="hand-cursor" onclick="actionQuery('<?=my_caption('support_ticket_rating')?>', '<?=my_caption('support_ticket_rating_2')?>, Are you sure?', '<?=base_url('user/ticket_rating_action/' . $rs->ids . '/2/')?>', '')"><span class="dot-yellow mr-1"></span> <?=my_caption('support_ticket_rating_2')?></a>
			</div>
		    <div class="col-lg-12 mt-3">
			  <a id="Rating1" class="hand-cursor" onclick="actionQuery('<?=my_caption('support_ticket_rating')?>', '<?=my_caption('support_ticket_rating_1')?>, Are you sure?', '<?=base_url('user/ticket_rating_action/' . $rs->ids . '/1/')?>', '')"><span class="dot-red mr-1"></span> <?=my_caption('support_ticket_rating_1')?></a>
			</div>
		  </div>
		</div>
      </div>
