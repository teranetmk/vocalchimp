<?php
  ...
  $menu_user_panel = '{
	  ...
	  "menu_user_profile" : {
		  "display" : 1,
		  "name" :"' . my_caption('menu_sidebar_user_tts') . '",
		  "icon" : "fas fa-broadcast-tower",
		  "link" : "tts/start",
		  "active_condition" : "tts/start,tts/view",
		  "child_menu" : {}
	  },
	  "menu_user_translation" : {
		  "display" : 1,
		  "name" :"My Translations",
		  "icon" : "fas fa-language",
		  "link" : "translation/start",
		  "active_condition" : "translation/start,translation/view",
		  "child_menu" : {}
	  },
	  "menu_user_ticket" : {
		  "display" : 1,
		  "name" : "Contact us ' . $user_new_ticket . '",
		  "icon" : "fas fa-tag",
		  "link" : "user/support",
		  "active_condition" : "user/support",
		  "child_menu" : {}
	  },
	  "menu_user_payment" : {
		  ...
		  "active_condition" : "",
		  "child_menu" : {
		  	  "menu_user_payment_info" : {
		  	  	"display": 1,
		  	  	"name": "Update Payment Info",
		  	  	"link": "user/payment_info",
		  	  	"active_condition" : "user/payment_info"
		  	  },
			  ...
			  "menu_user_payment_subscription_cancel" : {
  ...
  $menu_admin_panel = '{
	  ...
	  "menu_admin_payment" : {
		  ...
		  "child_menu" : {
			  ...
			  }' . my_hook_menu('admin_payment') . ',
			  "menu_admin_promocode_management" : {
			  	"display" : 1,
	  ...
	  "menu_admin_tts" : {
		  "display" : ' . my_check_permission('TTS Management') . ',
		  "name" : "' . my_caption('menu_sidebar_admin_tts') . '",
		  ...
		  "child_menu" : {
			  "menu_admin_tts_list" : {
				  "display" : 1,
				  "name" : "' . my_caption('menu_sidebar_admin_tts_list') . '",
				  "link" : "tts/admin_tts_list",
				  "active_condition" : "tts/admin_tts_list,tts/admin_tts_view"
			  },
			  "menu_admin_tts_configruation" : {
				  "display" : 1,
				  "name" : "' . my_caption('menu_sidebar_admin_tts_configuration') . '",
				  "link" : "tts/admin_configuration",
				  "active_condition" : "tts/admin_configuration,tts/admin_configuration_action"
			  }
		  }
	  },
	  "menu_admin_tool" : {
