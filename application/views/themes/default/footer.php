	  ...
	  $global_caption = my_caption('global_view') . '||';
		...
		$global_caption .= ($_SERVER['REQUEST_URI'] == '/user/pay_subscription_list') ? 'No, Keep Me Active' . '||' : my_caption('global_cancel') . '||';
  ...
  ?>
  <script src="<?=base_url()?>assets/themes/default/js/app.js?v=2.5"></script>
  <script src="<?=base_url()?>assets/themes/default/js/app_tts.js?v=2.5"></script>
</body>
</html>
