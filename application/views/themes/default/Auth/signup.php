				  ...
				  <?php
					if (set_value('email_address') == '') {
						...
						elseif (!empty($_SESSION['invite_email'])) {
							...
							$email_address = my_get('email_address');
						}
					}
					else {
                ...
                <div class="form-group row mb-4">
                  <div class="col-sm-12 mb-3 mb-sm-0">
                      <div class="custom-control custom-checkbox small">
                        ...
                        <label class="custom-control-label" for="tc_agree"><a href="<?php echo $policyURL; //site_url('privacy-policy');?>" target="_blank"><?=my_caption('signup_tc_agree')?></a></label>
                      </div>
