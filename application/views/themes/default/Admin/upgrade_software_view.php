...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<div class="col-lg-12">
	  ...
	  <input type="hidden" id="current_version" name="current_version" value="<?=my_esc_html($current_version)?>">
	  <input type="hidden" id="ready_version" name="ready_version" value="<?=my_esc_html($ready_version)?>">
	  <input type="hidden" id="script_ids" name="script_ids" value="<?=my_esc_html($script_ids)?>">
	    ...
	    <table class="table table-bordered">
          ...
          <tbody>
			<tr>
			  ...
			  <td>[<?=my_esc_html($script_type)?>] <?=my_esc_html($script_name)?></td>
			</tr>
			<tr>
			  <td class="text-center">2</td>
			  <td><b><?=my_caption('upgrade_software_current_version')?></b></td>
			  <td>v<?=my_esc_html($current_version)?></td>
			</tr>
			<tr>
			  ...
			  <td>
				...
				?>
				[ <?=my_caption('upgrade_software_release_date')?>: <?=my_esc_html($latest_version_date)?> ] <br>
			...
			?>
			  <tr>
			    ...
			    <td>v<?=my_esc_html($ready_version)?> [ <?=my_caption('upgrade_software_release_date')?>: <?=my_esc_html($ready_version_date)?> ] <br> <?=my_caption('upgrade_software_ready_version_notice')?></td>
			  </tr>
			<?php
				  }
				  else {
			...
			<tr>
			  ...
			  <td><b><?=my_caption('upgrade_software_ready_version_changelog')?> of v<?=my_esc_html($ready_version)?></b></td>
