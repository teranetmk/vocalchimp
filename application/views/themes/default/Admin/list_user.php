...
<input type="hidden" id="caption_subscription_action" name="caption_subscription_action" value="Cancel Subscription||Are you sure to cancel this subscription from payment gateway?||Forced To Cancel At Once||This operation can not be reverted, Are you sure to cancel now without refund?||Resume Subscription||Are you sure to resume this subscription from payment gateway?||Cancel After Period Ends||Cancel Subscription Immediately||Resume Subscription||Forced To Cancel At Once">
  <div class="row">
    <div class="col-lg-12">
