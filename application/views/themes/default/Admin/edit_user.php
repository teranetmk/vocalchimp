		...
		<div class="card-body">
		  ...
		  <div class="row mb-3">
		    <div class="col-lg-6">
			  ...
			  <p>
			    <?=my_esc_html($rs->balance)?>
			  </p>
			</div>
		    <div class="col-lg-6">
			  <span class="font-weight-bold"><?=my_caption('user_edit_info_balance_payg_title')?></span>
			  <p>
			    <?php echo my_caption('mp_my_payg_balance_characters') . $payg_balance?>
			  </p>
			</div>
		  </div>
		  <div class="row mb-3">
