...
class Dashboard extends MY_Controller {
	...
	public function dashboard_tts_statistics() {
		...
		if ($characters_preview_used > 1000000) {
			$characters_preview_used = doubleval($characters_preview_used/1000000) . 'M';
		}
		elseif ($characters_preview_used > 10000) {
			$characters_preview_used = doubleval($characters_preview_used/1000) . 'K';
		}
		...
		if ($characters_production_used > 1000000) {
			$characters_production_used = doubleval($characters_production_used/1000000) . 'M';
		}
		elseif ($characters_production_used > 10000) {
			$characters_production_used = doubleval($characters_production_used/1000) . 'K';
		}
