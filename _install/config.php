...
$html_title = 'CyberBukit TTS Installer';
$title = 'Install CyberBukit TTS';
...
$detect_directory_list = array('upload', 'backup', 'application/config', 'application/logs', 'application/cache/ci_session', 'application/libraries', 'tts_file/preview', 'tts_file/user');
...
function execute_db_installation($mysql_new_connection, $prefix) {
	...
	$sql .= 'insert into ' . $prefix . 'permission (ids, built_in, name) values
	  ...
	  (\'0D5mPEOrQ7aca71700c5c2bc2693adfb719566552iQEatJGXx\', 1, \'TTS_Management\');';
	...
	// tts_configuration
	$sql .= 'create table ' . $prefix . 'tts_configuration (
	  id int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	...
	$sql .= 'insert into ' . $prefix . 'tts_configuration (default_language, storage, download_type, maximum_character, maximum_character_preview, preview_delay, ssml, engine, clean_up, pricing_model, file_path_preview, file_path_user, aws, google, wasabi, azure) values
	  (\'en-US\', \'local\', \'friendly\', 3000, 50, 0, 0, \'both\', 0, \'{"enabled":1,"currency":"USD","price":"4","characters":"1000000"}\', \'tts_file/preview/\', \'tts_file/user/\', \'{"config_file":"","region":"","bucket":"","folder":""}\', \'{"config_file":""}\', \'{"config_file":"","region":"","bucket":"","folder":""}\', \'{"region":"southeastasia","subscription_key":""}\');';
	
	
	// tts_log
	$sql .= 'create table ' . $prefix . 'tts_log (
	  id int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	  ids char(50) NOT NULL,
	  user_ids char(50) NOT NULL,
	...
	// tts_preview_log
	$sql .= 'create table ' . $prefix . 'tts_preview_log (
	  id int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	  ids char(50) NOT NULL,
	  user_ids char(50) NOT NULL,
	  scheme varchar(50) NOT NULL,
	...
	// tts_resource
	$sql .= 'create table ' . $prefix . 'tts_resource (
	  id int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	  ids char(50) NOT NULL,
	  scheme varchar(50) NOT NULL,
	  language_name varchar(50) NOT NULL,
	...
	// tts_statitics
	$sql .= 'create table ' . $prefix . 'tts_statitics (
	  id int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	  user_ids char(50) NOT NULL,
	...
	$sql .= 'insert into ' . $prefix . 'tts_statitics (user_ids, payg_balance, payg_purchased, characters_preview_used, characters_production_used, voice_generated) values ("0bWHjn9usb065a85cc223037e3b5dff82c4c08fba2XaMlC3Gk", 0, 0, 0, 0, 0);';
